        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalInsuranceNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalLicenseNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    MedicalSpecialty = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentEndUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrescriptionNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_MedicalSpecialty",
                table: "Doctors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_DoctorId_AppointmentStartUtc",
                table: "Appointments",
                columns: new[] { "DoctorId", "AppointmentStartUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_PatientId_AppointmentStartUtc",
                table: "Appointments",
                columns: new[] { "PatientId", "AppointmentStartUtc" });
